 ...
 *
 * @QueueWorker(
 *   id = "up1_typo3_resume_queue",
 *   title = @Translation("Page Perso import resume text field."),
 *   cron = {"time" = 60}
 *  )
 */
class Typo3ResumeQueue extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  /**
